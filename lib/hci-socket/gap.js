...
var passiveScanning = false;  // Set to true to disable state tracking & enable passive only BLE scanning
...
Gap.prototype.startScanning = function(allowDuplicates, passive) {
  this._scanState = 'starting';
  this._scanFilterDuplicates = !allowDuplicates;
  passiveScanning = passive;
  // Always set scan parameters before scanning
  // https://www.bluetooth.org/docman/handlers/downloaddoc.ashx?doc_id=229737
  // p106 - p107
  this._hci.setScanEnabled(false, true);
  this._hci.setScanParameters(passive);
...
Gap.prototype.onHciLeAdvertisingReport = function(status, type, address, addressType, eir, rssi) {
    var previouslyDiscovered;
    var advertisement;
    var discoveryCount;
    var hasScanResponse;
  if(!passiveScanning){
      previouslyDiscovered = !!this._discoveries[address];
      advertisement =  previouslyDiscovered ? this._discoveries[address].advertisement : {
	  localName: undefined,
      ...
      discoveryCount = previouslyDiscovered ? this._discoveries[address].count : 0;
      hasScanResponse = previouslyDiscovered ? this._discoveries[address].hasScanResponse : false;
